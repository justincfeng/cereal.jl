...
function locatorselect( N::Int=5 , Method::String="RTC21" )
    ...
    elseif  N == 4
        ...
        elseif Method == "FHC24"
            return locator4FHC24
        elseif Method == "FHC24b"
            return locator4FHC24b
        else 
    ...
    elseif  N >= 5 && Method != "RTC21"
        ...
        elseif  Method == "FHC24"
            return (X,q=1e-14) -> mlocator(X,locator4FHC24,4,true,q)
        elseif  Method == "FHC24b"
            return (X,q=1e-14) -> mlocator(X,locator4FHC24b,4,true,q)
        else
            print("Unrecognized method.")
